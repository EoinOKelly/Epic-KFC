...
inline const QString UsernameResolveUnavailable = "Username lookup failed. Check the username, login state, and production /users/by-username endpoint availability.";
